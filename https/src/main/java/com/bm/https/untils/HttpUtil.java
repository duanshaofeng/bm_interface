...
public class HttpUtil {
     ...
     * @throws Exception
     */
    public static Object sendGet(String url, String appIdorSecretKey,
        ...
        try{
             ...
             * 设置请求头部编码
             */
            httpGet.setHeader(new BasicHeader("gateway_appid", appIdorSecretKey));
            /**
             * 设置返回编码
             */
           httpGet.setHeader(new BasicHeader("gateway_rtime", currTime));
           httpGet.setHeader(new BasicHeader("gateway_sig", sign));
     ...
     * @throws Exception
     */
    public static Object sendPost2(String url, String json) throws Exception{
        JSONObject jsonObject = null;
        CloseableHttpClient client = null;
        CloseableHttpResponse response = null;
        try{
