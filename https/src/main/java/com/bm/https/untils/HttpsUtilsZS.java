...
public class HttpsUtilsZS {

	private static Logger logger = LoggerFactory.getLogger(HttpsUtilsZS.class);
	/**
	 * 获得KeyStore.
	 *
	...
	public static String getServiceNetworkInformation(String xmlstr,String url) {
		...
		// 密钥库
		String keyStorePath =  "/home/explat/ESB/11295.p12";
		// 信任库
		String trustStorePath = "/home/explat/ESB/keystore.jks";
		...
		String result = "";
		try {
			sslContext = HttpsUtilsZS.getSSLContext(password,keyStorePath, trustStorePath);
