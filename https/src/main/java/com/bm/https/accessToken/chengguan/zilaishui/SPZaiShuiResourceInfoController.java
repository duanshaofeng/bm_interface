...
@RestController
@RequestMapping("/spzls")
public class SPZaiShuiResourceInfoController {
    private Logger logger = LoggerFactory.getLogger(SPZaiShuiResourceInfoController.class);
    ...
    public static void main(String[] args)throws Exception{
        ...
        Object post = AllHttpUntil.webserviceClient("http://118.190.180.133/services/PayService?wsdl","getcustlastpayment",jsonString);
