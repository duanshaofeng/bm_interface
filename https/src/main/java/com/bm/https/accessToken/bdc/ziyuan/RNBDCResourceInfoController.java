package com.bm.https.accessToken.bdc.ziyuan;
...
@Api(description  = "汝南不动产资源对接接口类")
@RestController
@RequestMapping("/rnbdc")
public class RNBDCResourceInfoController {
    private Logger logger = LoggerFactory.getLogger(RNBDCResourceInfoController.class);



    @Value("${connect.rnbdc.name}")
    private String rnbdcname;
    @Value("${connect.rnbdc.password}")
    private String rnbdcpassword;
    @Value("${connect.rnbdc.url}")
    private String rnbdcurl;
    ...
    @Value("${bdc.yydj.sql}")
    private String yydj;
    @Value("${bdc.tdsyqdj.sql}")
    private String tdsyqdj;


    @ApiOperation(value = "汝南不动产房地产权登记接口" ,  notes="返回参数")
    ...
    public Object fdcq(@RequestParam(value = "zjhm",required = true)String zjhm,
        ...
        try{
            ...
            logger.info("===============汝南不动产房地产权登记接口:参数  "+jsonString);
            List<Map<String, Object>> maps = BDCZYUtil.queryList(rnbdcurl, rnbdcname, rnbdcpassword, sql, param, paramType);
            String json = JSONObject.toJSONString(maps);
            logger.info("===============汝南不动产房地产权登记接口:返回  "+json);
    ...
    @ApiOperation(value = "汝南不动产林权登记接口" ,  notes="返回参数")
    ...
    public Object lq(@RequestParam(value = "zjhm",required = true)String zjhm,
        ...
        try{
            ...
            logger.info("===============汝南不动产林权登记接口:参数  "+jsonString);
            List<Map<String, Object>> maps = BDCZYUtil.queryList(rnbdcurl, rnbdcname, rnbdcpassword, sql, param, paramType);
            String json = JSONObject.toJSONString(maps);
            logger.info("===============汝南不动产林权登记接口:返回  "+json);
            msg.put("success",true);
            msg.put("msg","查询成功");
            msg.put("data",maps);
            return msg;
    ...
    @ApiOperation(value = "汝南不动产农用地登记接口" ,  notes="返回参数")
    ...
    public Object nyddj(@RequestParam(value = "zjhm",required = true)String zjhm,
        ...
        try{
            ...
            logger.info("===============汝南不动产农用地登记接口:参数  "+jsonString);
            List<Map<String, Object>> maps = BDCZYUtil.queryList(rnbdcurl, rnbdcname, rnbdcpassword, sql, param, paramType);
            String json = JSONObject.toJSONString(maps);
            logger.info("===============汝南不动产农用地登记接口:返回  "+json);
            msg.put("success",true);
            msg.put("msg","查询成功");
            msg.put("data",maps);
            return msg;
    ...
    @ApiOperation(value = "汝南不动产建设用地使用权、宅基地使用权登记接口" ,  notes="返回参数")
    ...
    public Object jsydsyq(@RequestParam(value = "zjhm",required = true)String zjhm,
        ...
        try{
            ...
            logger.info("===============汝南不动产建设用地使用权、宅基地使用权登记接口:参数  "+jsonString);
            List<Map<String, Object>> maps = BDCZYUtil.queryList(rnbdcurl, rnbdcname, rnbdcpassword, sql, param, paramType);
            String json = JSONObject.toJSONString(maps);
            logger.info("===============汝南不动产建设用地使用权、宅基地使用权登记接口:返回  "+json);
            msg.put("success",true);
            msg.put("msg","查询成功");
            msg.put("data",maps);
            return msg;
    ...
    @ApiOperation(value = "汝南不动产查封登记接口" ,  notes="返回参数")
    ...
    public Object cfdj(@RequestParam(value = "cfwh",required = true)String cfwh,
        ...
        try{
            ...
            logger.info("===============汝南不动产查封登记接口:参数  "+jsonString);
            List<Map<String, Object>> maps = BDCZYUtil.queryList(rnbdcurl, rnbdcname, rnbdcpassword, sql, param, paramType);
            String json = JSONObject.toJSONString(maps);
            logger.info("===============汝南不动产查封登记接口:返回  "+json);
            msg.put("success",true);
            msg.put("msg","查询成功");
            msg.put("data",maps);
            return msg;
     ...
     * @return
     */
    @ApiOperation(value = "汝南不动产预告登记接口" ,  notes="返回参数")
    ...
    public Object ygdj(@RequestParam(value = "name",required = true)String name,
        ...
        try{
            ...
            logger.info("===============汝南不动产预告登记接口:参数  "+jsonString);
            List<Map<String, Object>> maps = BDCZYUtil.queryList(rnbdcurl, rnbdcname, rnbdcpassword, sql, param, paramType);
            String json = JSONObject.toJSONString(maps);
            logger.info("===============汝南不动产预告登记接口:返回  "+json);
            msg.put("success",true);
            msg.put("msg","查询成功");
            msg.put("data",maps);
            return msg;
    ...
    @ApiOperation(value = "汝南不动产抵押登记接口" ,  notes="返回参数")
    ...
    public Object dydj(@RequestParam(value = "name",required = true)String name,
        ...
        try{
            ...
            logger.info("===============汝南不动产抵押登记接口:参数  "+jsonString);
            List<Map<String, Object>> maps = BDCZYUtil.queryList(rnbdcurl, rnbdcname, rnbdcpassword, sql, param, paramType);
            String json = JSONObject.toJSONString(maps);
            logger.info("===============汝南不动产抵押登记接口:返回  "+json);
            msg.put("success",true);
            msg.put("msg","查询成功");
            msg.put("data",maps);
            return msg;
    ...
    @ApiOperation(value = "汝南不动产异议登记接口" ,  notes="返回参数")
    @RequestMapping(value = "/yydj",method = {RequestMethod.POST})
    public Object yydj(@RequestParam(value = "name",required = true)String name,
                       @RequestParam(value = "zjhm",required = true)String zjhm,
                       @RequestParam(value = "bdcdjzmh",required = false)String bdcdjzmh,
                       @RequestParam(value = "bdcdyh",required = false)String bdcdyh){
        Map<String, Object> msg = new HashMap<>();
        try{
            ...
            String jsonString = JSONObject.toJSONString(map);
            if(StringUtils.isNotEmpty(bdcdjzmh)&&StringUtils.isEmpty(bdcdyh)){
                sql = yydj + " and t1.bdcdjzmh = ? ";
                param = new Object[]{zjhm,name,bdcdjzmh};
                paramType = new int[]{12,12,12};
            }else if (StringUtils.isEmpty(bdcdjzmh)&&StringUtils.isNotEmpty(bdcdyh)){
                sql = yydj + " and t1.bdcdyh = ?  ";
                param = new Object[]{zjhm,name,bdcdyh};
                paramType = new int[]{12,12,12};
            }else if (StringUtils.isNotEmpty(bdcdjzmh)&&StringUtils.isNotEmpty(bdcdyh)){
                sql = yydj + " and t1.bdcdjzmh = ? and t1.BDCDYH = ?";
                param = new Object[]{zjhm,name,bdcdjzmh,bdcdyh};
                paramType = new int[]{12,12,12,12};
            }else if (StringUtils.isEmpty(bdcdjzmh)&&StringUtils.isEmpty(bdcdyh)){
                sql = yydj ;
            ...
            logger.info("===============汝南不动产异议登记接口:参数  "+jsonString);
            List<Map<String, Object>> maps = BDCZYUtil.queryList(rnbdcurl, rnbdcname, rnbdcpassword, sql, param, paramType);
            String json = JSONObject.toJSONString(maps);
            logger.info("===============汝南不动产异议登记接口:返回  "+json);
            msg.put("success",true);
            msg.put("msg","查询成功");
            msg.put("data",maps);
            return msg;
    ...
    @ApiOperation(value = "汝南不动产土地所有权登记接口" ,  notes="返回参数")
    @RequestMapping(value = "/tdsyqdj",method = {RequestMethod.POST})
    public Object tdsyqdj(@RequestParam(value = "zjhm",required = true)String zjhm,
                          @RequestParam(value = "name",required = true)String name,
                          @RequestParam(value = "djlx",required = false)String djlx,
                          @RequestParam(value = "bdcqzh",required = false)String bdcqzh,
                          @RequestParam(value = "bdcdyh",required = false)String bdcdyh){
        ...
        try{
            ...
            String jsonString = JSONObject.toJSONString(map);
            if(StringUtils.isNotEmpty(djlx)&&StringUtils.isEmpty(bdcqzh)&&StringUtils.isEmpty(bdcdyh)){
                sql = tdsyqdj + " and t2.DJLX = ? ";
                param = new Object[]{zjhm,name,djlx};
                paramType = new int[]{12,12,12};
            }else if (StringUtils.isNotEmpty(djlx)&&StringUtils.isNotEmpty(bdcqzh)&&StringUtils.isEmpty(bdcdyh)){
                sql = tdsyqdj + " and t2.DJLX = ? and t.BDCQZH = ? ";
                param = new Object[]{zjhm,name,djlx,bdcqzh};
                paramType = new int[]{12,12,12,12};
            }else if (StringUtils.isNotEmpty(djlx)&&StringUtils.isEmpty(bdcqzh)&&StringUtils.isNotEmpty(bdcdyh)){
                sql = tdsyqdj + " and t2.DJLX = ? and t.BDCDYH = ?";
                param = new Object[]{zjhm,name,djlx,bdcdyh};
                paramType = new int[]{12,12,12,12};
            }else if (StringUtils.isEmpty(djlx)&&StringUtils.isNotEmpty(bdcqzh)&&StringUtils.isNotEmpty(bdcdyh)){
                sql = tdsyqdj + " and t.BDCQZH = ? and t.BDCDYH = ?";
                param = new Object[]{zjhm,name,bdcqzh,bdcdyh};
                paramType = new int[]{12,12,12,12};
            }else if (StringUtils.isNotEmpty(djlx)&&StringUtils.isNotEmpty(bdcqzh)&&StringUtils.isNotEmpty(bdcdyh)){
                sql = tdsyqdj + " and t2.DJLX = ? and t.BDCQZH = ? and t.BDCDYH = ?";
                param = new Object[]{zjhm,name,djlx,bdcqzh,bdcdyh};
                paramType = new int[]{12,12,12,12,12};
            }else if (StringUtils.isEmpty(djlx)&&StringUtils.isEmpty(bdcqzh)&&StringUtils.isNotEmpty(bdcdyh)){
                sql = tdsyqdj + " and t.BDCDYH = ?";
                param = new Object[]{zjhm,name,bdcdyh};
                paramType = new int[]{12,12,12};
            }else if (StringUtils.isEmpty(djlx)&&StringUtils.isNotEmpty(bdcqzh)&&StringUtils.isEmpty(bdcdyh)){
                sql = tdsyqdj + " and t.BDCQZH = ?";
                param = new Object[]{zjhm,name,bdcqzh};
                paramType = new int[]{12,12,12};
            }else if (StringUtils.isEmpty(djlx)&&StringUtils.isEmpty(bdcqzh)&&StringUtils.isEmpty(bdcdyh)){
                sql = tdsyqdj ;
            ...
            logger.info("===============汝南不动产土地所有权登记接口:参数  "+jsonString);
            List<Map<String, Object>> maps = BDCZYUtil.queryList(rnbdcurl, rnbdcname, rnbdcpassword, sql, param, paramType);
            String json = JSONObject.toJSONString(maps);
            logger.info("===============汝南不动产土地所有权登记接口:返回  "+json);
            msg.put("success",true);
            msg.put("msg","查询成功");
            msg.put("data",maps);
            return msg;
