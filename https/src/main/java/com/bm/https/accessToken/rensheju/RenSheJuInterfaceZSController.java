package com.bm.https.accessToken.rensheju;
...
public class RenSheJuInterfaceZSController {
	private Logger logger = LoggerFactory.getLogger(RenSheJuInterfaceZSController.class);
