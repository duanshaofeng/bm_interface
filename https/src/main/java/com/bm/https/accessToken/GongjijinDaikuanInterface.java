...
/**
 * Created by 86133 on 2020/7/2.
 */
@Api(description  = "公积金贷款接口类")
@RestController
@RequestMapping("/gjj")
public class GongjijinDaikuanInterface {

    private Logger logger = LoggerFactory.getLogger(GongjijinDaikuanInterface.class);

    @ApiOperation(value = "个人基本信息变更查询")
    @RequestMapping(value = "/jcrbgxxcx2",method = {RequestMethod.POST})
    public Object jcrbgxxcx2(@RequestParam(value = "zjhm",required = true)String zjhm,
    ...
    @RequestMapping(value = "/grdzdcx2",method = {RequestMethod.POST})
    public Object grdzdcx2(@RequestParam(value = "zjhm",required = true)String zjhm){
        Map map  = new HashMap<>();
        map.put("zjhm",zjhm);
        String param = JSONObject.toJSONString(map);
    ...
    @RequestMapping(value = "/dkllcx2",method = {RequestMethod.POST})
    public Object dkllcx2(@RequestParam(value = "dknx",required = true)String dknx,
    ...
    @RequestMapping(value = "/sydkjejs2",method = {RequestMethod.POST})
    public Object sydkjejs2(@RequestParam(value = "dkhkfs",required = true)String dkhkfs,
    ...
    @RequestMapping(value = "/dkjsq2",method = {RequestMethod.POST})
    public Object dkjsq2(@RequestParam(value = "dkhkfs",required = true)String dkhkfs,
                         @RequestParam(value = "dkje",required = true)String dkje,
                         @RequestParam(value = "dkqx",required = true)String dkqx,
    ...
    @RequestMapping(value = "/jdcx2",method = {RequestMethod.POST})
    public Object jdcx2(@RequestParam(value = "jkrzjh",required = true)String jkrzjh){
        Map map  = new HashMap<>();
    ...
    @RequestMapping(value = "/dkhkjhcx2",method = {RequestMethod.POST})
    public Object dkhkjhcx2(@RequestParam(value = "jkrzjh",required = true)String jkrzjh){
        Map map  = new HashMap<>();
        map.put("jkrzjh",jkrzjh);
        String param = JSONObject.toJSONString(map);
    ...
    @RequestMapping(value = "/jkhtxxcx2",method = {RequestMethod.POST})
    public Object jkhtxxcx2(@RequestParam(value = "jkrzjh",required = false)String jkrzjh,
    ...
    @RequestMapping(value = "/xmwtyhcx2",method = {RequestMethod.POST})
    public Object xmwtyhcx2(){
        Map map  = new HashMap<>();
        map.put("cxlx"," ");
        String param = JSONObject.toJSONString(map);
    ...
    @RequestMapping(value = "/hkzhbglcfq2",method = {RequestMethod.POST})
    public Object hkzhbglcfq2(@RequestParam(value = "jkhtbh",required = true)String jkhtbh,
    ...
    @RequestMapping(value = "/qydchdcx2",method = {RequestMethod.POST})
    public Object qydchdcx2(@RequestParam(value = "jkhtbh",required = true)String jkhtbh){
        Map map  = new HashMap<>();
        map.put("jkhtbh",jkhtbh);
        String param = JSONObject.toJSONString(map);
    ...
    @RequestMapping(value = "/qydchdlcfqnew2",method = {RequestMethod.POST})
    public Object qydchdlcfqnew2(@RequestParam(value = "jkhtbh",required = true)String jkhtbh,
    ...
    @RequestMapping(value = "/bghqccx2",method = {RequestMethod.POST})
    public Object bghqccx2(@RequestParam(value = "jkhtbh",required = true)String jkhtbh,
    ...
    @RequestMapping(value = "/jsqqccx2",method = {RequestMethod.POST})
    public Object jsqqccx2(@RequestParam(value = "sydkje",required = true)String sydkje,
    ...
    @RequestMapping(value = "/tqhkchk2",method = {RequestMethod.POST})
    public Object tqhkchk2(@RequestParam(value = "jkhtbh",required = true)String jkhtbh,
    ...
    @RequestMapping(value = "/tqhkqccx2",method = {RequestMethod.POST})
    public Object tqhkqccx2(@RequestParam(value = "jkhtbh",required = true)String jkhtbh){
        Map map  = new HashMap<>();
        map.put("jkhtbh",jkhtbh);
        String param = JSONObject.toJSONString(map);
    ...
    @RequestMapping(value = "/tqhklxjs12",method = {RequestMethod.POST})
    public Object tqhklxjs12(@RequestParam(value = "jkhtbh",required = true)String jkhtbh,
    ...
    @RequestMapping(value = "/jkrtqhblcfq2",method = {RequestMethod.POST})
    public Object jkrtqhblcfq2(@RequestParam(value = "jkhtbh",required = true)String jkhtbh,
                               @RequestParam(value = "jkrxm",required = true)String jkrxm,
                               @RequestParam(value = "jkrzjh",required = true)String jkrzjh,
    ...
    @RequestMapping(value = "/tqhklxjs2",method = {RequestMethod.POST})
    public Object tqhklxjs2(@RequestParam(value = "jkhtbh",required = true)String jkhtbh,
                            @RequestParam(value = "tqhkbj",required = true)String tqhkbj,
                            @RequestParam(value = "ywlx",required = true)String ywlx){
        Map map  = new HashMap<>();
        map.put("jkhtbh",jkhtbh);
    ...
    @ApiOperation(value = "提前部分还款-提前结清完成办理")
    @RequestMapping(value = "/jkrtqjqlcfq2",method = {RequestMethod.POST})
    public Object jkrtqjqlcfq2(@RequestParam(value = "jkhtbh",required = true)String jkhtbh,
                               @RequestParam(value = "jkrxm",required = true)String jkrxm,
                               @RequestParam(value = "jkrzjh",required = true)String jkrzjh,
                               @RequestParam(value = "grbh",required = true)String grbh,
                               @RequestParam(value = "tqhkje",required = true)String tqhkje,
        ...
        map.put("bxhj",bxhj);
        String param = JSONObject.toJSONString(map);
        logger.info("公积金接口 提前部分还款-提前结清完成办理====方法名：jkrtqjqlcfq=======入参："+param);
        try{
            String url = "http://59.207.236.111:81/zw-web/jkr/jkrtqjqlcfq";
            logger.info("公积金接口 提前部分还款-提前结清完成办理====方法名：jkrtqjqlcfq=======请求url："+url);
            Object string = AllHttpUntil.sendPost2(url, map);
            logger.info("公积金接口 提前部分还款-提前结清完成办理====方法名：jkrtqjqlcfq=======返回值："+string);
            return string;
        }catch (Exception e){
            e.printStackTrace();
            logger.error(e.getMessage());
