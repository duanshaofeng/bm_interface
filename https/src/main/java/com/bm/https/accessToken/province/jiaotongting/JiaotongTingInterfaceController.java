package com.bm.https.accessToken.province.jiaotongting;
...
@RestController
@RequestMapping("/jtt")
public class JiaotongTingInterfaceController {
    private Logger logger = LoggerFactory.getLogger(JiaotongTingInterfaceController.class);
