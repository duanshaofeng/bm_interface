...
@Api(description  = "泌阳不动产资源对接接口类")
@RestController
@RequestMapping("/bybdc")
public class BYBDCResourceInfoController {
    private Logger logger = LoggerFactory.getLogger(BYBDCResourceInfoController.class);



    @Value("${connect.bybdc.name}")
    private String bybdcname;
    @Value("${connect.bybdc.password}")
    private String bybdcpassword;
    @Value("${connect.bybdc.url}")
    private String bybdcurl;
    ...
    @ApiOperation(value = "泌阳不动产房地产权登记接口" ,  notes="返回参数")
    ...
    public Object fdcq(@RequestParam(value = "zjhm",required = true)String zjhm,
        ...
        try{
            ...
            logger.info("===============泌阳不动产房地产权登记接口:参数  "+jsonString);
            List<Map<String, Object>> maps = BDCZYUtil.queryList(bybdcurl, bybdcname, bybdcpassword, sql, param, paramType);
            String json = JSONObject.toJSONString(maps);
            logger.info("===============泌阳不动产房地产权登记接口:返回  "+json);
    ...
    @ApiOperation(value = "泌阳不动产林权登记接口" ,  notes="返回参数")
    ...
    public Object lq(@RequestParam(value = "zjhm",required = true)String zjhm,
        ...
        try{
            ...
            logger.info("===============泌阳不动产林权登记接口:参数  "+jsonString);
            List<Map<String, Object>> maps = BDCZYUtil.queryList(bybdcurl, bybdcname, bybdcpassword, sql, param, paramType);
            String json = JSONObject.toJSONString(maps);
            logger.info("===============泌阳不动产林权登记接口:返回  "+json);
            msg.put("success",true);
            msg.put("msg","查询成功");
            msg.put("data",maps);
            return msg;
    ...
    @ApiOperation(value = "泌阳不动产农用地登记接口" ,  notes="返回参数")
    ...
    public Object nyddj(@RequestParam(value = "zjhm",required = true)String zjhm,
        ...
        try{
            ...
            logger.info("===============泌阳不动产农用地登记接口:参数  "+jsonString);
            List<Map<String, Object>> maps = BDCZYUtil.queryList(bybdcurl, bybdcname, bybdcpassword, sql, param, paramType);
            String json = JSONObject.toJSONString(maps);
            logger.info("===============泌阳不动产农用地登记接口:返回  "+json);
            msg.put("success",true);
            msg.put("msg","查询成功");
            msg.put("data",maps);
            return msg;
    ...
    @ApiOperation(value = "泌阳不动产建设用地使用权、宅基地使用权登记接口" ,  notes="返回参数")
    ...
    public Object jsydsyq(@RequestParam(value = "zjhm",required = true)String zjhm,
        ...
        try{
            ...
            logger.info("===============泌阳不动产建设用地使用权、宅基地使用权登记接口:参数  "+jsonString);
            List<Map<String, Object>> maps = BDCZYUtil.queryList(bybdcurl, bybdcname, bybdcpassword, sql, param, paramType);
            String json = JSONObject.toJSONString(maps);
            logger.info("===============泌阳不动产建设用地使用权、宅基地使用权登记接口:返回  "+json);
            msg.put("success",true);
            msg.put("msg","查询成功");
            msg.put("data",maps);
            return msg;
    ...
    @ApiOperation(value = "泌阳不动产查封登记接口" ,  notes="返回参数")
    ...
    public Object cfdj(@RequestParam(value = "cfwh",required = true)String cfwh,
        ...
        try{
            ...
            logger.info("===============泌阳不动产查封登记接口:参数  "+jsonString);
            List<Map<String, Object>> maps = BDCZYUtil.queryList(bybdcurl, bybdcname, bybdcpassword, sql, param, paramType);
            String json = JSONObject.toJSONString(maps);
            logger.info("===============泌阳不动产查封登记接口:返回  "+json);
            msg.put("success",true);
            msg.put("msg","查询成功");
            msg.put("data",maps);
            return msg;
     ...
     * @return
     */
    @ApiOperation(value = "泌阳不动产预告登记接口" ,  notes="返回参数")
    ...
    public Object ygdj(@RequestParam(value = "name",required = true)String name,
        ...
        try{
            ...
            logger.info("===============泌阳不动产预告登记接口:参数  "+jsonString);
            List<Map<String, Object>> maps = BDCZYUtil.queryList(bybdcurl, bybdcname, bybdcpassword, sql, param, paramType);
            String json = JSONObject.toJSONString(maps);
            logger.info("===============泌阳不动产预告登记接口:返回  "+json);
            msg.put("success",true);
            msg.put("msg","查询成功");
            msg.put("data",maps);
            return msg;
    ...
    @ApiOperation(value = "泌阳不动产抵押登记接口" ,  notes="返回参数")
    ...
    public Object dydj(@RequestParam(value = "name",required = true)String name,
        ...
        try{
            ...
            logger.info("===============泌阳不动产抵押登记接口:参数  "+jsonString);
            List<Map<String, Object>> maps = BDCZYUtil.queryList(bybdcurl, bybdcname, bybdcpassword, sql, param, paramType);
            String json = JSONObject.toJSONString(maps);
            logger.info("===============泌阳不动产抵押登记接口:返回  "+json);
            msg.put("success",true);
            msg.put("msg","查询成功");
            msg.put("data",maps);
            return msg;
