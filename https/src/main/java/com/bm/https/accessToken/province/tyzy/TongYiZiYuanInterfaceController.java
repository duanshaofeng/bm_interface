package com.bm.https.accessToken.province.tyzy;
...
@RestController
@RequestMapping("/tyzy")
public class TongYiZiYuanInterfaceController {
    private Logger logger = LoggerFactory.getLogger(TongYiZiYuanInterfaceController.class);
