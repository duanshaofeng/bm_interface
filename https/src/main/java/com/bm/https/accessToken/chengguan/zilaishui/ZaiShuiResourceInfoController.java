...
@RestController
@RequestMapping("/zls")
public class ZaiShuiResourceInfoController {
    private Logger logger = LoggerFactory.getLogger(ZaiShuiResourceInfoController.class);
    ...
    public ResponseEntity<byte[]> spfzjjg(HttpServletRequest request, HttpServletResponse response)
    {
