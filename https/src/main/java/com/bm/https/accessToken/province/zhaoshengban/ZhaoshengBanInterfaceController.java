package com.bm.https.accessToken.province.zhaoshengban;
...
@RestController
@RequestMapping("/zsb")
public class ZhaoshengBanInterfaceController {
    private Logger logger = LoggerFactory.getLogger(ZhaoshengBanInterfaceController.class);
