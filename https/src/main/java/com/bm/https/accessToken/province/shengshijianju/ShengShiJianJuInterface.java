package com.bm.https.accessToken.province.shengshijianju;
...
@RestController
@RequestMapping("/sjj")
public class ShengShiJianJuInterface {

    private Logger logger = LoggerFactory.getLogger(ShengShiJianJuInterface.class);
    ...
    public Object FDCQCX(@RequestParam(value = "uniscid",required = true)String uniscid,@RequestParam(value = "regno",required = true)String regno,
        ...
        try{
            ...
            map.put("regno",regno);
            map.put("ws-SecurityUsername","3b20a5fec2ba4d8992d61810c9d66ff9");
            map.put("ws-SecurityPassword","M2IyMGE1ZmVjMmJhNGQ4OTkyZDYxODEwYzlkNjZmZjk6MTIzNDU2");
