package com.bm.https.accessToken.province.rensheting;
...
@RestController
@RequestMapping("/renshe")
public class RenSheTingInterfaceController {
    private Logger logger = LoggerFactory.getLogger(RenSheTingInterfaceController.class);
    ...
    @RequestMapping(value = "/CBRYSHBXJFInfo",method = {RequestMethod.POST})
