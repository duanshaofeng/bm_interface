package com.bm.https.accessToken.bdc;

import com.alibaba.fastjson.JSONArray;
import com.alibaba.fastjson.JSONObject;
import com.bm.https.pojo.DjzmData;
import com.bm.https.pojo.QlzsData;
...
@RestController
@RequestMapping("/bdc")
public class BDCZSInterfaceController {
    private Logger logger = LoggerFactory.getLogger(BDCZSInterfaceController.class);
    @Autowired
