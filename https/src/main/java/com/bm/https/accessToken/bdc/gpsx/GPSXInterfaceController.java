package com.bm.https.accessToken.bdc.gpsx;
...
@RestController
@RequestMapping("/gpsx")
public class GPSXInterfaceController {
    private Logger logger = LoggerFactory.getLogger(GPSXInterfaceController.class);
