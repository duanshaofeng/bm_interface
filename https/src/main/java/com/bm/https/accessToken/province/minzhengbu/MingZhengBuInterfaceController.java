package com.bm.https.accessToken.province.minzhengbu;
...
@RestController
@RequestMapping("/mzb")
public class MingZhengBuInterfaceController {
    private Logger logger = LoggerFactory.getLogger(MingZhengBuInterfaceController.class);
