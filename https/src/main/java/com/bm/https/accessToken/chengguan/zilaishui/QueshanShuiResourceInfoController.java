...
@RestController
@RequestMapping("/qszls")
public class QueshanShuiResourceInfoController {
    private Logger logger = LoggerFactory.getLogger(QueshanShuiResourceInfoController.class);
