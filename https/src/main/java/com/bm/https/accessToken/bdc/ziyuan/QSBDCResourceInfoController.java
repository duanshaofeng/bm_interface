...
@Api(description  = "确山不动产资源对接接口类")
@RestController
@RequestMapping("/qsbdc")
public class QSBDCResourceInfoController {
    private Logger logger = LoggerFactory.getLogger(QSBDCResourceInfoController.class);



    @Value("${connect.qsbdc.name}")
    private String qsbdcname;
    @Value("${connect.qsbdc.password}")
    private String qsbdcpassword;
    @Value("${connect.qsbdc.url}")
    private String qsbdcurl;
    ...
    @ApiOperation(value = "确山不动产房地产权登记接口" ,  notes="返回参数")
    ...
    public Object fdcq(@RequestParam(value = "zjhm",required = true)String zjhm,
        ...
        try{
            ...
            logger.info("===============确山不动产房地产权登记接口:参数  "+jsonString);
            List<Map<String, Object>> maps = BDCZYUtil.queryList(qsbdcurl, qsbdcname, qsbdcpassword, sql, param, paramType);
            String json = JSONObject.toJSONString(maps);
            logger.info("===============确山不动产房地产权登记接口:返回  "+json);
    ...
    @ApiOperation(value = "确山不动产林权登记接口" ,  notes="返回参数")
    ...
    public Object lq(@RequestParam(value = "zjhm",required = true)String zjhm,
        ...
        try{
            ...
            logger.info("===============确山不动产林权登记接口:参数  "+jsonString);
            List<Map<String, Object>> maps = BDCZYUtil.queryList(qsbdcurl, qsbdcname, qsbdcpassword, sql, param, paramType);
            String json = JSONObject.toJSONString(maps);
            logger.info("===============确山不动产林权登记接口:返回  "+json);
            msg.put("success",true);
            msg.put("msg","查询成功");
            msg.put("data",maps);
            return msg;
    ...
    @ApiOperation(value = "确山不动产农用地登记接口" ,  notes="返回参数")
    ...
    public Object nyddj(@RequestParam(value = "zjhm",required = true)String zjhm,
        ...
        try{
            ...
            logger.info("===============确山不动产农用地登记接口:参数  "+jsonString);
            List<Map<String, Object>> maps = BDCZYUtil.queryList(qsbdcurl, qsbdcname, qsbdcpassword, sql, param, paramType);
            String json = JSONObject.toJSONString(maps);
            logger.info("===============确山不动产农用地登记接口:返回  "+json);
            msg.put("success",true);
            msg.put("msg","查询成功");
            msg.put("data",maps);
            return msg;
    ...
    @ApiOperation(value = "确山不动产建设用地使用权、宅基地使用权登记接口" ,  notes="返回参数")
    ...
    public Object jsydsyq(@RequestParam(value = "zjhm",required = true)String zjhm,
        ...
        try{
            ...
            logger.info("===============确山不动产建设用地使用权、宅基地使用权登记接口:参数  "+jsonString);
            List<Map<String, Object>> maps = BDCZYUtil.queryList(qsbdcurl, qsbdcname, qsbdcpassword, sql, param, paramType);
            String json = JSONObject.toJSONString(maps);
            logger.info("===============确山不动产建设用地使用权、宅基地使用权登记接口:返回  "+json);
            msg.put("success",true);
            msg.put("msg","查询成功");
            msg.put("data",maps);
            return msg;
    ...
    @ApiOperation(value = "确山不动产查封登记接口" ,  notes="返回参数")
    ...
    public Object cfdj(@RequestParam(value = "cfwh",required = true)String cfwh,
        ...
        try{
            ...
            logger.info("===============确山不动产查封登记接口:参数  "+jsonString);
            List<Map<String, Object>> maps = BDCZYUtil.queryList(qsbdcurl, qsbdcname, qsbdcpassword, sql, param, paramType);
            String json = JSONObject.toJSONString(maps);
            logger.info("===============确山不动产查封登记接口:返回  "+json);
            msg.put("success",true);
            msg.put("msg","查询成功");
            msg.put("data",maps);
            return msg;
     ...
     * @return
     */
    @ApiOperation(value = "确山不动产预告登记接口" ,  notes="返回参数")
    ...
    public Object ygdj(@RequestParam(value = "name",required = true)String name,
        ...
        try{
            ...
            logger.info("===============确山不动产预告登记接口:参数  "+jsonString);
            List<Map<String, Object>> maps = BDCZYUtil.queryList(qsbdcurl, qsbdcname, qsbdcpassword, sql, param, paramType);
            String json = JSONObject.toJSONString(maps);
            logger.info("===============确山不动产预告登记接口:返回  "+json);
            msg.put("success",true);
            msg.put("msg","查询成功");
            msg.put("data",maps);
            return msg;
    ...
    @ApiOperation(value = "确山不动产抵押登记接口" ,  notes="返回参数")
    ...
    public Object dydj(@RequestParam(value = "name",required = true)String name,
        ...
        try{
            ...
            logger.info("===============确山不动产抵押登记接口:参数  "+jsonString);
            List<Map<String, Object>> maps = BDCZYUtil.queryList(qsbdcurl, qsbdcname, qsbdcpassword, sql, param, paramType);
            String json = JSONObject.toJSONString(maps);
            logger.info("===============确山不动产抵押登记接口:返回  "+json);
            msg.put("success",true);
            msg.put("msg","查询成功");
            msg.put("data",maps);
            return msg;
