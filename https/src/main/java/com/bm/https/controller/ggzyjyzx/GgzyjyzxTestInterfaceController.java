...
@RestController
@RequestMapping("/test/ggzyjyzx")
public class GgzyjyzxTestInterfaceController {
    private Logger logger = LoggerFactory.getLogger(GgzyjyzxTestInterfaceController.class);
