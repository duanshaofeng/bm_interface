package com.bm.https.controller.province.weijianwei;
...
@RestController
@RequestMapping("/wjwtest")
public class WeijianWeiInterfaceTestController {
    private Logger logger = LoggerFactory.getLogger(WeijianWeiInterfaceTestController.class);
    ...
    public Object jhsyInfo(@RequestParam(value = "xml",required = false)String xml){
        try{
            ...
            Object data = ProvinceUtils.httpDatapostjson( jsonString, "http://59.207.107.18:5000/api/getCsrkInfo",appId,appKey);
