...
@Api(description  = "平舆自来水资源ZS对接接口类")
@RestController
@RequestMapping("/zs/pyzls")
public class PYZaiShuiResourceInfoZSController {
    private Logger logger = LoggerFactory.getLogger(PYZaiShuiResourceInfoZSController.class);
