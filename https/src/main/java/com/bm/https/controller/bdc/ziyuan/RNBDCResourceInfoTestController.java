...
@RestController
@RequestMapping("/rnbdctest")
public class RNBDCResourceInfoTestController {
    private Logger logger = LoggerFactory.getLogger(RNBDCResourceInfoTestController.class);
