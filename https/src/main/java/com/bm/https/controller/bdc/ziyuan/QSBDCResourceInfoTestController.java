...
@RestController
@RequestMapping("/qsbdctest")
public class QSBDCResourceInfoTestController {
    private Logger logger = LoggerFactory.getLogger(QSBDCResourceInfoTestController.class);
