...
import com.bm.https.accessToken.HttpsControllerZS;
...
public class HttpsController {
    ...
    private Logger logger = LoggerFactory.getLogger(HttpsController.class);

    @ApiOperation(value = "测试连通性" ,  notes="返回参数")
    @RequestMapping(value = "/getCRMTest1",method = {RequestMethod.POST,RequestMethod.GET})
    ...
    public String getGRDKCX(@RequestParam(value = "jkrzjh",required = false)String jkrzjh){
         ...
         */
        Map map  = new HashMap<>();
       /* map.put("zxbm","01");map.put("jgbm"," ");map.put("ywbm","%");map.put("khbh"," ");map.put("zhbh"," ");
        map.put("blqd","zxb");map.put("userid","2");map.put("swtyhbm","%");map.put("dysflr","全部");map.put("jkhtbh_begin","");
        map.put("fxdj"," ");map.put("dkje_begin","0");map.put("dkje_end","100");map.put("dknx_begin","0");map.put("dknx_end","60");
        map.put("qzlrrq_begin","");map.put("qzlrrq_end","");map.put("dkhkfs","全部");map.put("fwzj_end","9999");map.put("posfgjjjk"," ");
        map.put("sfyddkh"," ");map.put("page","1");map.put("sfcdy","2");map.put("jkrzjh",jkrzjh);map.put("dkzt","");
        map.put("kfsmc"," ");map.put("htrq_begin","");map.put("htrq_end","");map.put("ffrq_begin","");map.put("ffrq_end","");
        map.put("jqrq_begin","");map.put("jqrq_end","");map.put("dwzh"," ");map.put("jkrdwmc"," ");map.put("dkdblx","全部");
        map.put("xmmc"," ");map.put("fwxz"," ");map.put("zfmj_begin","0");map.put("zfmj_end","9999");map.put("gflx","全部");
        map.put("fwzj_begin","0");map.put("sfydc","2");map.put("dah"," ");map.put("yqts","0");map.put("size","999");
     */
