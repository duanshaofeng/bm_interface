...
@RestController
@RequestMapping("/bybdctest")
public class BYBDCResourceInfoTestController {
    private Logger logger = LoggerFactory.getLogger(BYBDCResourceInfoTestController.class);
