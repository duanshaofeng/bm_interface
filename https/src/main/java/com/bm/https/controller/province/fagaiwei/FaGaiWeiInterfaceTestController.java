package com.bm.https.controller.province.fagaiwei;
...
@RestController
@RequestMapping("/fgwtest")
public class FaGaiWeiInterfaceTestController {
    private Logger logger = LoggerFactory.getLogger(FaGaiWeiInterfaceTestController.class);
