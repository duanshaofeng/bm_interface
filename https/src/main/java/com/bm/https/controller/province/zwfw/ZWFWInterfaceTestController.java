package com.bm.https.controller.province.zwfw;
...
@RestController
@RequestMapping("/zwfwtest")
public class ZWFWInterfaceTestController {
    private Logger logger = LoggerFactory.getLogger(ZWFWInterfaceTestController.class);
