...
@RestController
@RequestMapping("/test/fgw")
public class FagaiweiResourceInfoTestController {
    private Logger logger = LoggerFactory.getLogger(FagaiweiResourceInfoTestController.class);
...
//TODO
    ...
    public Object getCreditCodeListByWs(@RequestParam(value = "searchContent",required = false) String searchContent,
                          @RequestParam(value = "page",required = false) String page   ,
                                        @RequestParam(value = "pagesize",required = false) String pagesize ){
        Map<String, String> map = new HashMap<>();
        try{
