package com.bm.https.controller.province.zhufang;
...
@RestController
@RequestMapping("/szftest")
public class ZhuFangInterfaceTestController {
    private Logger logger = LoggerFactory.getLogger(ZhuFangInterfaceTestController.class);
    ...
    @ApiOperation(value = "公积金运行统计情况" ,  notes="返回参数")
    @RequestMapping(value = "/zjt_gjjyxtjcx",method = {RequestMethod.POST})
    public Object zjt_gjjyxtjcx(@RequestParam(value = "year",required = true)String year){
        try{
    ...
    public Object zcgjszsxx(@RequestParam(value = "zjhm",required = true)String zjhm){
        ...
        try{
            ...
            map2.put("arguments",map);
            String jsonString = JSONObject.toJSONString(map2);
            logger.info("房地产估价师证书信息查询V1.0参数====="+jsonString);
            ...
            logger.info("房地产估价师证书信息查询返回=="+data);//HNS_ZJT_FDCGJS
            return data;
        }catch (Exception e){
            e.printStackTrace();
            return null;
    ...
    public Object gczjzxzz(@RequestParam(value = "Corpcode",required = true)String Corpcode){
        ...
        try{
            ...
            map2.put("arguments",map);
            String jsonString = JSONObject.toJSONString(map2);
            logger.info("工程造价咨询企业资质证书信息查询参数====="+jsonString);
            ...
            logger.info("工程造价咨询企业资质证书信息查询返回=="+data);
            return data;
        }catch (Exception e){
            e.printStackTrace();
            return null;
    ...
    public Object ejjzszczsxx2(@RequestParam(value = "zcbh",required = true)String zcbh){
        try{
            ...
            map2.put("arguments",map);
            String jsonString = JSONObject.toJSONString(map2);
            logger.info("二级建造师证书信息查询(通过证书编号查询)参数====="+jsonString);
            ...
            logger.info("二级建造师证书信息查询(通过证书编号查询)返回=="+data);
            return data;
        }catch (Exception e){
            e.printStackTrace();
            return null;
    ...
    @ApiOperation(value = "安全生产考核合格证书 " ,  notes="返回参数")
    @RequestMapping(value = "/aqsckhhgzsxx",method = {RequestMethod.POST})
    public Object aqsckhhgzsxx(@RequestParam(value = "qymc",required = true)String qymc,
        ...
        try{
            ...
            map.put("zsbh",zsbh);
            String jsonString = JSONObject.toJSONString(map);
            logger.info("安全生产考核合格证书 参数====="+jsonString);
            Object data = ProvinceUtils.httpDatapost(map, "http://59.207.107.18:5000/api/inservicedemo/microinservice/direct/aqsckhhgzsxx",appId,appKey);
            logger.info("安全生产考核合格证书 返回=="+data);
            return data;
        }catch (Exception e){
            e.printStackTrace();
            return null;
