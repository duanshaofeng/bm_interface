...
@Api(description  = "上蔡自来水资源ZS对接接口类")
@RestController
@RequestMapping("/zs/sczls")
public class SCZaiShuiResourceInfoZSController {
    private Logger logger = LoggerFactory.getLogger(SCZaiShuiResourceInfoZSController.class);
