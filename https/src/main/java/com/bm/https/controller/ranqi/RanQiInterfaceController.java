package com.bm.https.controller.ranqi;
...
@RestController
@RequestMapping("/test/rq")
public class RanQiInterfaceController {
	private Logger logger = LoggerFactory.getLogger(RanQiInterfaceController.class);
