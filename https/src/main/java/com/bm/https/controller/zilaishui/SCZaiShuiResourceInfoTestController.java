...
@Api(description  = "上蔡自来水资源对接接口类")
@RestController
@RequestMapping("/test/sczls")
public class SCZaiShuiResourceInfoTestController {
    private Logger logger = LoggerFactory.getLogger(SCZaiShuiResourceInfoTestController.class);




    @ApiOperation(value = "上蔡自来水查询客户信息接口" ,  notes="返回参数")
    ...
    @ApiOperation(value = "上蔡自来水缴费返回信息接口" ,  notes="返回参数")
    ...
    @ApiOperation(value = "上蔡自来水查询应缴信息接口" ,  notes="返回参数")
    ...
    public Object getcustwaterrate(@RequestParam("userid") String userid,
        ...
        try{
            ...
            map.put("loginpass",loginpass);
            String jsonString1 = JSONObject.toJSONString(map);
            logger.info("===============上蔡自来水查询应缴信息接口参数:  "+jsonString1);
            Object post1 = AllHttpUntil.webserviceClient("http://118.190.180.133/services/PayService?wsdl","getcustwaterrate",jsonString1);
            logger.info("===============上蔡自来水查询应缴信息接口查询:返回  "+JSONObject.toJSONString(post1));
            return post1;
        }catch (Exception e){
            e.printStackTrace();
            return "error";
    ...
    @ApiOperation(value = "上蔡自来水历史水费查询信息接口" ,  notes="返回参数")
    ...
    public Object getcustlastwaterrecord(@RequestParam("watercode") String watercode,
        ...
        try{
            ...
            String jsonString1 = JSONObject.toJSONString(map);
            logger.info("===============上蔡自来水历史水费查询信息接口参数:  "+jsonString1);
            ...
            logger.info("===============上蔡自来水历史水费查询信息接口返回:  "+post1);
            logger.info("===============上蔡自来水历史水费查询信息查询:集合返回  "+JSONObject.toJSONString(post1));
            return post1;
    ...
    @ApiOperation(value = "上蔡自来水历史缴费记录查询信息接口" ,  notes="返回参数")
    ...
    public Object getcustlastpayment(@RequestParam("userid") String userid,
        ...
        try{
            ...
            map.put("startdate",startdate);
            String jsonString1 = JSONObject.toJSONString(map);
            logger.info("===============上蔡自来水历史缴费记录查询信息接口参数:  "+jsonString1);
            Object post1 = AllHttpUntil.webserviceClient("http://118.190.180.133/services/PayService?wsdl","getcustlastpayment",jsonString1);
            logger.info("===============上蔡自来水历史缴费记录查询信息接口返回:  "+post1);
            logger.info("===============上蔡自来水历史缴费记录查询信息查询:集合返回  "+JSONObject.toJSONString(post1));
            return post1;
        }catch (Exception e){
            e.printStackTrace();
            return "error";
    ...
    @ApiOperation(value = "上蔡自来水查询交易汇总信息接口" ,  notes="返回参数")
        ...
        try{
            ...
            if(post!=null){
                ...
                for(int i = 0;i < maps.size();i++){
                    ...
                    String jsonString1 = JSONObject.toJSONString(map);
                    logger.info("===============上蔡自来水查询交易汇总信息接口参数:  "+jsonString1);
                    Object post1 = AllHttpUntil.webserviceClient("http://118.190.180.133/services/PayService?wsdl","getpaycollect",jsonString1);
                    logger.info("===============上蔡自来水查询交易汇总信息接口返回:  "+post1);
                    objects.add(post1);
                }
                logger.info("===============上蔡自来水查询交易汇总信息查询:集合返回  "+JSONObject.toJSONString(objects));
                return objects;
            }
    ...
    public static void main(String[] args) throws Exception {
       ...
       // map.put("seltype", "0");
        String jsonString = JSONObject.toJSONString(map);
        System.out.println("===============上蔡自来水查询客户信息接口参数:  " + jsonString);
        ...
        System.out.println("===============上蔡自来水查询客户信息接口查询:返回  " + JSONObject.toJSONString(post));
     ...
     * 是否将上传下载的报文写入日志中
     */
    @ApiOperation(value = "上蔡自来水水价查询接口", notes = "返回参数")
    ...
    @ApiOperation(value = "上蔡自来水网点查询接口", notes = "返回参数")
    ...
    public Object wdcx() {
        ...
        try {
            ...
            map.put("data", data);
            logger.info("===============上蔡自来水网点查询接口:返回  " + JSONObject.toJSONString(data));
            return map;
        } catch (Exception e) {
            e.printStackTrace();
            map.put("status", "1");
