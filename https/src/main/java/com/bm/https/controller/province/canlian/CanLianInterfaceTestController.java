package com.bm.https.controller.province.canlian;
...
@RestController
@RequestMapping("/cltest")
public class CanLianInterfaceTestController {
    private Logger logger = LoggerFactory.getLogger(CanLianInterfaceTestController.class);
