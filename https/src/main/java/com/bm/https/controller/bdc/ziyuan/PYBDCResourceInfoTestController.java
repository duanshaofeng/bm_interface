...
@RestController
@RequestMapping("/pybdctest")
public class PYBDCResourceInfoTestController {
    private Logger logger = LoggerFactory.getLogger(PYBDCResourceInfoTestController.class);
