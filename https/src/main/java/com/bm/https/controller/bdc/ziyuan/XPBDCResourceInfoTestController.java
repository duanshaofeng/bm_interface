...
@RestController
@RequestMapping("/xpbdctest")
public class XPBDCResourceInfoTestController {
    private Logger logger = LoggerFactory.getLogger(XPBDCResourceInfoTestController.class);
