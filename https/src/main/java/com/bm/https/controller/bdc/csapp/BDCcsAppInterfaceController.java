package com.bm.https.controller.bdc.csapp;
...
public class BDCcsAppInterfaceController {
    private Logger logger = LoggerFactory.getLogger(BDCcsAppInterfaceController.class);
    ...
    public Object ZSQuery(@RequestParam(value = "SQRMC",required = false)String SQRMC,@RequestParam(value = "SLBH",required = false)String SLBH,
                           @RequestParam(value = "SQRZJHM",required = false)String SQRZJHM,@RequestParam(value = "CXYWLSH",required = false)String CXYWLSH){
        try{
    ...
    public Object ZMQuery(@RequestParam(value = "SQRMC",required = false)String SQRMC,@RequestParam(value = "SLBH",required = false)String SLBH,
                          @RequestParam(value = "SQRZJHM",required = false)String SQRZJHM,@RequestParam(value = "CXYWLSH",required = false)String CXYWLSH){
        try{
    ...
    public Object HTQuery(@RequestParam(value = "SQRMC",required = false)String SQRMC,@RequestParam(value = "SLBH",required = false)String SLBH,
                          @RequestParam(value = "SQRZJHM",required = false)String SQRZJHM,@RequestParam(value = "CXYWLSH",required = false)String CXYWLSH){
        try{
    ...
    public Object GRZFQuery(@RequestParam(value = "SQRMC",required = false)String SQRMC,@RequestParam(value = "SLBH",required = false)String SLBH,
                          @RequestParam(value = "SQRZJHM",required = false)String SQRZJHM,@RequestParam(value = "CXYWLSH",required = false)String CXYWLSH){
        try{
    ...
    public Object YWJDQuery(@RequestParam(value = "SQRMC",required = false)String SQRMC,@RequestParam(value = "SLBH",required = false)String SLBH,
                          @RequestParam(value = "SQRZJHM",required = false)String SQRZJHM,@RequestParam(value = "CXYWLSH",required = false)String CXYWLSH){
        try{
